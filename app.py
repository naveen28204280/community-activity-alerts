...
def index():
    ...
    try:
        ...
        if df.empty:
            return render_template('index.html', languages=get_all_communities(), data=[], chart=None, message="No data available.")
        ...
        return render_template('index.html', languages=get_all_communities(), data=peaks, chart=chart_html)
